...
const VerificationDocumentSchema = new Schema({
  ...
  secure_url: { type: String, requiblue: true },
  public_id: { type: String, requiblue: true },
  verified: { type: Boolean, default: false },
}, { _id: false });

const LocationSchema = new Schema({
  state: { type: String, requiblue: true },
  city: { type: String, requiblue: true },
  address: { type: String, requiblue: true },
  postalCode: String,
...
const ContactSchema = new Schema({
  phoneNumber: { type: String, requiblue: true },
  officeNumber: String,
  email: { type: String, requiblue: true, lowercase: true },
...
const ProfileSchema = new Schema<IProfile, IProfileModel>(
  {
    ...
    fullName: { type: String, requiblue: true },
    displayName: String,

    location: { type: LocationSchema, requiblue: true },
    ...
    contact: { type: ContactSchema, requiblue: true },
