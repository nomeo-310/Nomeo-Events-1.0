...
export default function NotFound() {
  ...
  return (
    <div className="flex items-center justify-center w-full min-h-screen dark:bg-neutral-900">
      <div className="flex md:gap-6 items-center flex-col md:flex-row p-8 gap-14">
        ...
        >
          ...
          <motion.div
            className="absolute inset-0 rounded-md border-2 border-primary-blue"
            animate={{
              scale: [1, 1.05, 1],
              opacity: [0.3, 0.6, 0.3],
            }}
        ...
        {/* Content */}
        <div className="text-blue-600 max-w-lg">
          <motion.h1
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 bg-blue-600 hover:bg-blue-400 
