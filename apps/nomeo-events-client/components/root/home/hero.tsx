      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <button
            ...
            className="group inline-flex items-center justify-center gap-2 px-8 py-3 bg-indigo-600 text-white rounded-full font-semibold text-lg shadow-md hover:opacity-90 transition-opacity duration-200"
          >
            Get Started Free
          ...
          <button
            ...
            className="inline-flex items-center justify-center px-8 py-3 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-full font-semibold text-lg border border-gray-300 dark:border-gray-600 hover:border-indigo-500 dark:hover:border-indigo-500 transition-colors duration-200"
          >
            See How It Works
          </button>
        </div>
