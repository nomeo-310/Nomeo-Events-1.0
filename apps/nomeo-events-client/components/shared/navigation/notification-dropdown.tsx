  ...
  return (
    <Dropdown isOpen={isOpen} onClose={onClose} width="w-80">
      ...
      <div className="px-4 py-2.5 border-t border-gray-100 dark:border-gray-800">
        <Link href="/dashboard" onClick={onClose} className="text-xs text-indigo-600 dark:text-indigo-400 font-medium hover:underline block text-center" prefetch={true}>
